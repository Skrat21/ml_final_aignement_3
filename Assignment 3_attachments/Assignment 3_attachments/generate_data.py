...
data_path=os.path.join(os.path.dirname(__file__), "Data.csv")#replace with data path
output_path=os.path.join(os.path.dirname(__file__), "your_data.csv")#replace with output data path
